...
@Composable
fun AuthenticatedProfileScreen(navController: NavHostController,authViewModel: AuthViewModel) {
...
fun PreviewAuthenticatedProfilePage() {
    AuthenticatedProfileScreen(rememberNavController(), authViewModel = hiltViewModel())
}
