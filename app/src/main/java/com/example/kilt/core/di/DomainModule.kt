...
import com.example.kilt.domain.favorites.usecase.GetUserFavoritesUseCase
...
object DomainModule {
    ...
    @Provides
    @Singleton
    fun provideGetUserFavoritesUseCase(repository:FavoritesRepository,getUserIdUseCase: GetUserIdUseCase):GetUserFavoritesUseCase{
        return GetUserFavoritesUseCase(repository,getUserIdUseCase)
    }

    @Provides
    @Singleton
    fun provideGetListingByIdUseCase(repository: SearchRepository): GetListingByIdUseCase {
        return GetListingByIdUseCase(repository)
    }

    @Provides
    @Singleton
    fun provideGetListingsByIdsUseCase(repository: SearchRepository):GetListingsByIdsUseCase{
        return GetListingsByIdsUseCase(repository)
    }
