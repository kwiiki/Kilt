...
import com.example.kilt.data.favorites.dto.UserAndFavoriteId
import com.example.kilt.data.favorites.dto.UserFavoritesDTO
...
interface ApiService {
    @GET("listings/{id}")
    suspend fun getListingById(@Path("id") id: String): HomeSale

//    @GET("listings/{id}")
//    suspend fun getListingById(@Path("id") id: String): PropertyItem
    ...
    @POST("listings/search")
    suspend fun searchByListingsId(@Body request: SearchByListingsIdRequest): SearchByListingsIdResponse
    ...
    @GET("users/get-favorites/{id}")
    suspend fun getUserFavorites(@Path("id") id: String): UserFavoritesDTO

    @POST("users/sync-favorites")
    suspend fun addToFavoriteList(@Body userAndFavoriteId: UserAndFavoriteId)
