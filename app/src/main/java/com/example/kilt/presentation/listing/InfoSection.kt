...
@Composable
fun InfoSection(homeSale: HomeSale?, listingViewModel: ListingViewModel, configViewModel: ConfigViewModel) {
    val homeSaleView by listingViewModel.homeSale
    listingViewModel.loadHomeSale()
    val config = listingViewModel.config
