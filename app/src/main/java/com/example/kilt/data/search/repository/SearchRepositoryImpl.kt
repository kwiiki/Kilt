...
class SearchRepositoryImpl(
    ...
    override suspend fun getListingById(id: String):HomeSale {
        return apiService.getListingById(id)
    }

    override suspend fun getListingsById(searchByListingsIdRequest: SearchByListingsIdRequest): SearchByListingsIdResponse {
        val response = apiService.searchByListingsId(request = searchByListingsIdRequest)
        Log.d("pagingData", "getListingsById: ${searchByListingsIdRequest.toString()}")
        Log.d("pagingData", "getListingsById: ${response.toString()}")
        return response
    }
